...
import flag_ae from '../../../assets/images/flags/ae.svg';
import flag_french from '../../../assets/images/flags/french.svg';
import flag_us from '../../../assets/images/flags/us.svg';
import flag_spain from '../../../assets/images/flags/spain.svg';
                            ...
                            <div className="dropdown ms-1 topbar-head-dropdown header-item">
                                ...
                                <div className="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="javascript:void(0);" className="dropdown-item notify-item language" data-lang="fr" title="French">
                                        <img src={flag_french} alt="user-image" className="me-2 rounded" height={18} />
                                    ...
                                    <a href="javascript:void(0);" className="dropdown-item notify-item language" data-lang="ar" title="Arabic">
                                        <img src={flag_ae} alt="user-image" className="me-2 rounded" height={18} />
                                ...
                                <button type="button" className="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span className="d-flex align-items-center">
                                        ...
                                        <span className="text-start ms-xl-2">
                                            <span className="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Bobo</span>
                                            <span className="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Dev</span>
                                        </span>
                                    </span>
                                </button>
                                <div className="dropdown-menu dropdown-menu-end">
